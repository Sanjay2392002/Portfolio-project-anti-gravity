...
import { LayoutDashboard, UserCircle, Briefcase, ListTree, Settings, LogOut, Mail, Tag, Code, Calendar } from 'lucide-react';
...
const Sidebar = () => {
  ...
  const links = [
    ...
    { to: '/services', label: 'Services', icon: <Code size={20} /> },
    { to: '/experience', label: 'Experience', icon: <Calendar size={20} /> },
